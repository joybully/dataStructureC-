...
private:
  NodeType1<ItemType>* listData;
  int length;
  NodeType1<ItemType>* currentPos;
};
template<class ItemType>
struct NodeType1
{
...
{
  NodeType1<ItemType>* newNode;  // pointer to node being inserted
  NodeType1<ItemType>* predLoc;  // trailing pointer
  NodeType1<ItemType>* location; // traveling pointer
  bool moreToSearch;
  ...
  newNode = new NodeType1<ItemType>;
  newNode->info = item;
...
{
    NodeType1<ItemType>* location = listData;
    NodeType1<ItemType>* tempLocation;
