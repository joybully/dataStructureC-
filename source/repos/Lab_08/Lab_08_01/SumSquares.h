...
void UnsortedType<ItemType>::PrintSumSquares() {
    std::cout << SumSquares_a(listData) << endl;
    std::cout << SumSquares_b(listData) << endl;
    std::cout << SumSquares_c(listData) << endl;
    std::cout << SumSquares_d(listData) << endl;
    std::cout << SumSquares_e(listData) << endl;
}
